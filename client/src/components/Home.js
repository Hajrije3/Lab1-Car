...
<div className="box-container">
    ...
    <div className="box">
        <h3>our branches</h3>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> Kosovo </a>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> Albania </a>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> Macedonia </a>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> Germany </a>
    ...
    <div className="box">
        ...
        <a href="#"> <i className="fas fa-envelope"></i> hajrijeberisha0@gmail.com</a>
        <a href="#"> <i className="fas fa-map-marker-alt"></i> Prishtine, Kosove  </a>
    </div>
...
<div className="credit"> created by Lab1 | all rights reserved </div>
